...
#pragma warning(default : 4355)
    ...
    /* virtual */ uint32_t RemoteControl::TouchEvent(const uint8_t index, const uint16_t state, const uint16_t x, const uint16_t y)
    {
        return (_touchHandler->TouchEvent(index, state, x, y));
    }
